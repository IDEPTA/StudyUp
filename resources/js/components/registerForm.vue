<template>
    <div>
        <form @submit.prevent="register(name, lastname, email, phone, password, password_confirmation)" method="post">
            <p>Имя</p>
...
export default {
    ...
    methods: {
        async register(name, lastname, email, phone, password, password_confirmation) {
            this.errors = []
            this.message = ''
            let data = {
                name: name,
